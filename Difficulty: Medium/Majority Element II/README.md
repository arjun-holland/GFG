...
<strong>Explanation: </strong>5 and 6 occur more n/3 times.<br></span></pre>
<pre><span><strong>Input: </strong>arr[] = [-5, 1, -5]
<strong>Output: </strong>-5<br><strong>Explanation: </strong>-5 occurs more than n/3 times.</span></pre>
<pre><span style="font-size: 18px;"><strong>Input: </strong>arr[] = [1, 2, 3, 4, 5]
<strong>Output: </strong>[]<br><strong>Explanation: </strong>no candidate occur more than n/3 times.</span></pre>
<p><strong><span style="font-size: 18px;">Constraint:</span></strong><br><span style="font-size: 18px;">1 &lt;= arr.size() &lt;= 10<sup>6</sup><br>-10<sup>6</sup> &lt;= arr[i] &lt;= 10<sup>6</sup></span></p></div>